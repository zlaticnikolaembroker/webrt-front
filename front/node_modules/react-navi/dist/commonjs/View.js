...
var ViewHeadRendererContext_1 = require("./ViewHeadRendererContext");
...
function useView(_a) {
    ...
    var renderHeadFromContext = React.useContext(ViewHeadRendererContext_1.ViewHeadRendererContext);
    ...
    var connect = React.useCallback(function (children) {
        return (React.createElement(NaviContext_1.NaviContext.Provider, { value: childContext }, // Clone the content to force a re-render even if content hasn't
        ...
        if (final && route && unconsumedChunks.length !== 0) {
            if (nextRoute && nextRoute.type !== 'busy') {
                ...
                if (!disableScrolling &&
                    ...
                    HashScroll_1.scrollToHash(nextRoute.url.hash, prevRoute &&
                        prevRoute.url &&
                        prevRoute.url.pathname === nextRoute.url.pathname
                        ? hashScrollBehavior
                        : 'auto');
